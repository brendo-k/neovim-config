...
-- Taken from: https://xata.io/blog/configuring-neovim-coding-agents
local M = {}
...
require('brenden.custom.directory-watcher').registerOnChangeHandler('hotreload', function(filepath, events)
